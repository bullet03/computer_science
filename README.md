...
- FinalizationRegistry. колбэк очистки (финализатор)
- Прмер FinalizationRegistry + weakRef. [Ссылка на главу](https://learn.javascript.ru/weakref-finalizationregistry)
```js
function fetchImg() {
